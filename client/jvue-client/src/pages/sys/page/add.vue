  ...
  <div>
    <el-form ref="pageAdd" :model="pageAdd.form" label-width="150px" class="container-form__mid">
      ...
      <el-form-item label="画面名称" :error="errors.first('pageName')">
        <el-input v-model="pageAdd.form.name" data-vv-name="pageName" v-validate
                  data-vv-rules="required|max:20"></el-input>
      </el-form-item>
      <el-form-item label="画面类型" :error="errors.first('pageType')">
        <el-radio-group size="small" v-model="pageAdd.form.type" data-vv-name="pageType" v-validate
      ...
      <el-form-item label="画面路径" :error="errors.first('pagePath')">
        <el-input v-model="pageAdd.form.path" data-vv-name="pagePath" v-validate
                  data-vv-rules="required|max:120"></el-input>
      </el-form-item>
      <el-form-item label="画面组件" :error="errors.first('pageComponent')">
        <el-input v-model="pageAdd.form.component" data-vv-name="pageComponent" v-validate
                  data-vv-rules="required|max:120"></el-input>
      </el-form-item>
