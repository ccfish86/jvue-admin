<template>
  <div>
    ...
    <el-form ref="roleGrant" :model="roleGrant.form" label-width="150px" >
        <template v-for="menu of roleGrant.currentPages">
          <el-row>
            <el-col :span="2">
              <div>{{menu.name}}</div>
            </el-col>
            <el-col :span="22" >
              <el-row>
              <el-col :span="24" v-for="smenu of menu.children" :key="smenu.id">
                <!--<el-checkbox-group v-model="roleGrant.form.menus" @change="handleCheckedCitiesChange">-->
                  <!--<el-checkbox v-for="city in cities" :label="city" :key="city">{{city}}</el-checkbox>-->
                <!--</el-checkbox-group>-->
                <el-checkbox :label="smenu.name" v-model="smenu.checked"></el-checkbox>
                <el-row v-if="roleGrant.allRoleInfo.apis[smenu.id]">
                  <el-col :span="1">
                    <div class="txt-small">API</div>
                  </el-col>
                  <el-col :span="23">
                    <el-checkbox v-for="api of roleGrant.allRoleInfo.apis[smenu.id]" :key="api.id" :label="api.name" v-model="api.checked"></el-checkbox>
                  </el-col>
                </el-row>

                <el-row v-if="roleGrant.allRoleInfo.segments[smenu.id]">
                  <el-col :span="1">
                    <div class="txt-small">片段 </div>
                  </el-col>
                  <el-col :span="23">
                    <el-checkbox v-for="segment of roleGrant.allRoleInfo.segments[smenu.id]" :key="segment.id" :label="segment.name" v-model="segment.checked"></el-checkbox>
                  </el-col>
                </el-row>
              </el-col>
              </el-row>
